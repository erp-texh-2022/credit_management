...
class ResPartner(models.Model):
    ...
    def _check_overdue_invoices(self):
        ...
        for partner in self:
            for invoice in partner.invoice_ids.filtered(lambda i: i.state == 'posted' and i.move_type == 'out_invoice' and i.payment_state in ('partial', 'not_paid') and i.invoice_date_due and i.invoice_date_due < fields.Date.today()):
